...
function Button({ children, to, type, disabled, onClick }) {
  const base =
    "inline-block px-4 text-xs sm:text-sm rounded-full bg-lime-500  font-semibold tracking-wide text-stone-800 uppercase transition-colors hover:bg-lime-300 focus:bg-lime-300 focus:ring focus:ring-lime-300 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed";
  const styles = {
